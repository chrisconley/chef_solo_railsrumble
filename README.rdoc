...
On host:
  ...
  * wget http://gist.github.com/raw/132506/986dddee9b9c4c14e8de147abc17b95644684219/gistfile1.txt -O - | sh && cd /tmp && git clone git://github.com/retr0h/chef_solo_railsrumble.git && cd chef_solo_railsrumble && rake solo
